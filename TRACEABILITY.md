...
| PS-020–PS-024 | Immutable requirement revisions, source traceability, direct/task-backed coverage, retirement |
| PS-030–PS-033 | Plan fingerprinting, all-at-once structural validation, current-plan gate |
...
| PS-060–PS-062 | Worktree assignment context, scoped credentials, revocation |
| PS-070–PS-073 | Worker questions, blockers, risks, and follow-up proposals |
| PS-080–PS-083 | Checkpoint commits, immutable submissions, correction/idempotency rules |
...
| PS-140–PS-144 | Scoped requirement verification currency and explicit project completion |
