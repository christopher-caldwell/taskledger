...
from .core import now, taskledger_home
...
def connect(path: Path | None = None) -> sqlite3.Connection:
    path = path or taskledger_home() / "taskledger.sqlite3"
